...
from Motor_Tecnico.accio_engine.marketing_plan_application.command_inputs import ActivateMarketingPlanInput
...
from Motor_Tecnico.accio_engine.marketing_plan_domain.commands import ActivatePlanCommand
...
class ActivateMarketingPlan:
    ...
    def __call__(self, ctx: ApplicationContext, data: ActivateMarketingPlanInput) -> CommandResult:
        ...
        try:
            result = self._domain.activate_plan(command)
