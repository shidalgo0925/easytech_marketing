...
from Motor_Tecnico.accio_engine.marketing_plan_application.command_inputs import CreateMarketingPlanInput
...
from Motor_Tecnico.accio_engine.marketing_plan_domain.commands import CreatePlanCommand
...
class CreateMarketingPlan:
    ...
    def __call__(self, ctx: ApplicationContext, data: CreateMarketingPlanInput) -> CommandResult:
        ...
        try:
            result = self._domain.create_plan(command)
