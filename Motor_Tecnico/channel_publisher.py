...
def publish(connector_id: str, force: bool = False, dry_run: bool = False, tenant_id: str | None = None) -> int:
    ...
    args = [str(VENV_PYTHON), str(script), f"--tenant-id={tenant_id}"]
...
def main() -> None:
    ...
    raise SystemExit(publish(connector_id, force=force, dry_run=dry_run, tenant_id=tenant_id))
